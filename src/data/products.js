...
export const products = [
  product({
    ...
    sizeGuide: 't-shirts', newArrival: true, image: '/images/products/all-i-know-is-win-tee-black.webp', related: ['p015','p016','p020'],
  }),
  product({
    ...
    sizeGuide: 't-shirts', newArrival: true, image: '/images/products/hoops-for-troops-tee-black.webp', related: ['p014','p016','p020'],
  }),
  product({
    ...
    sizeGuide: 't-shirts', newArrival: true, image: '/images/products/hoopers-performance-tee-black.webp', related: ['p017','p018','p015'],
  }),
  product({
    ...
    sizeGuide: 'tops', newArrival: true, image: '/images/products/hoopers-long-sleeve-performance-grey.webp', related: ['p016','p019','p015'],
  }),
  product({
    ...
    colors: [{ ...C.black, image: '/images/products/lha-performance-shorts-black.webp' }], stockPerVariant: 12,
    ...
    image: '/images/products/lha-performance-shorts-black.webp', related: ['p016','p019','p029'],
  }),
  product({
    ...
    sizeGuide: 't-shirts', newArrival: true, image: '/images/products/lha-logo-performance-tee-black.webp', related: ['p016','p017','p018'],
  }),
  product({
    ...
    image: '/images/products/libya-hoops-academy-tee-black.webp', related: ['p014','p019','p021'],
  }),
  product({
    ...
    image: '/images/products/lha-chest-logo-tank-white.webp', related: ['p022','p023','p019'],
  }),
  product({
    ...
    image: '/images/products/lha-center-logo-tank-white.webp', related: ['p021','p023','p019'],
  }),
  product({
    ...
    image: '/images/products/lha-compression-long-sleeve-white.webp', related: ['p021','p022','p024'],
  }),
  ...
  product({
    ...
    colors: [
      ...
      { ...C.grey, name: { en: 'Light Grey', ar: 'رمادي فاتح' }, image: '/images/products/lha-premium-fleece-set-grey.webp' },
  ...
  product({ id:'p032', slug:'own-the-game-essential-tee', sku:'LHA-TEE-OTG', name:{en:'LHA Own The Game Tee',ar:'LHA Own The Game Tee'}, description:{en:'Premium relaxed tee with the small LHA Own The Game chest mark.',ar:'تيشيرت فاخر بقصة مريحة مع شعار LHA الصغير وعبارة امتلك اللعبة.'}, category:'clothing', subcategory:'t-shirts', productType:'T-Shirt', available: false, comingSoon: true, price:0, colors:[{...C.black,image:'/images/products/own-the-game-essential-tee-black.webp'},{...C.grey,image:'/images/products/own-the-game-essential-tee-grey.webp'},{...C.white,image:'/images/products/own-the-game-essential-tee-white.webp'}], stockPerVariant:12, material:{en:'Premium cotton blend',ar:'مزيج قطني فاخر'}, fit:{en:'Relaxed athletic fit',ar:'قصة رياضية مريحة'}, care:{en:'Machine wash cold.',ar:'يُغسل بارداً.'}, features:{en:['Small LHA chest mark','Three colours'],ar:['شعار LHA صغير','ثلاثة ألوان']}, sizeGuide:'t-shirts',newArrival:true,featured:true,image:'/images/products/own-the-game-essential-tee-black.webp',related:['p033','p014'] }),
  product({ id:'p033', slug:'own-the-game-sleeveless-top', sku:'LHA-TOP-OTG', name:{en:'LHA Own The Game Sleeveless Top',ar:'LHA Own The Game Sleeveless Top'}, description:{en:'Oversized sleeveless basketball top with a small LHA chest mark.',ar:'توب كرة سلة واسع بدون أكمام مع شعار LHA صغير.'}, category:'clothing', subcategory:'tops', productType:'Sleeveless Top', available: false, comingSoon: true, price:0, colors:[{...C.black,image:'/images/products/own-the-game-sleeveless-top-black.webp'},{...C.white,image:'/images/products/own-the-game-sleeveless-top-white.webp'},{...C.grey,image:'/images/products/own-the-game-sleeveless-top-grey.webp'}], stockPerVariant:12, material:{en:'Breathable cotton blend',ar:'مزيج قطني جيد التهوية'}, fit:{en:'Oversized sleeveless fit',ar:'قصة واسعة بدون أكمام'}, care:{en:'Machine wash cold.',ar:'يُغسل بارداً.'}, features:{en:['Sleeveless basketball cut','Three colours'],ar:['قصة كرة سلة بدون أكمام','ثلاثة ألوان']}, sizeGuide:'tops',newArrival:true,featured:true,image:'/images/products/own-the-game-sleeveless-top-black.webp',related:['p032','p020'] }),
  ...
  product({
    ...
    colors: [
      ...
      { ...C.grey, name: { en: 'Light Grey', ar: 'رمادي فاتح' }, image: '/images/products/own-the-game-zip-hoodie-grey.webp' },
    ...
    image: '/images/products/own-the-game-zip-hoodie-black.webp', related: ['p035','p029','p032'],
  }),
  product({
    ...
    colors: [
      ...
      { ...C.grey, name: { en: 'Light Grey', ar: 'رمادي فاتح' }, image: '/images/products/own-the-game-crewneck-grey.webp' },
    ...
    image: '/images/products/own-the-game-crewneck-black.webp', related: ['p034','p029','p032'],
  }),
  ...
  product({
    ...
    image: '/images/products/own-the-game-fleece-shorts-black.webp', related: ['p034','p035','p037'],
  }),
  product({
    ...
    colors: [
      ...
      { ...C.grey, name: { en: 'Light Grey', ar: 'رمادي فاتح' }, image: '/images/products/own-the-game-pullover-hoodie-grey.webp' },
    ...
    sizeGuide: 'hoodies', newArrival: true, featured: true,
    image: '/images/products/own-the-game-pullover-hoodie-black.webp', related: ['p034','p035','p036'],
  }),
  product({
    ...
    colors: [
      { ...C.black, image: '/images/products/own-the-game-fleece-pants-black.webp' },
    ],
    stockPerVariant: 12,
    material: { en: 'Heavyweight brushed fleece', ar: 'فليس ثقيل مبطن وناعم' },
    ...
    image: '/images/products/own-the-game-fleece-pants-black.webp', related: ['p034','p036','p037'],
  }),
];
