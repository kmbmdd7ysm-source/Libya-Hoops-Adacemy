...
const HELP_TOPICS = [
  ...
  {
    id: 'programs',
    title: { en: 'Programs & Registration', ar: 'البرامج والتسجيل' },
    summary: {
      en: 'Explore the academy programs and upcoming events currently published on the site. Registration actions are available only where the relevant program or event page provides them.',
      ar: 'استكشف برامج الأكاديمية والفعاليات القادمة المنشورة حالياً على الموقع. تتوفر إجراءات التسجيل فقط عندما تعرضها صفحة البرنامج أو الفعالية المعنية.',
    },
    keywords: {
      en: ['program', 'registration', 'event', 'training'],
      ar: ['برنامج', 'تسجيل', 'فعالية', 'تدريب'],
    },
    links: [
      { to: '/programs', label: { en: 'Programs', ar: 'البرامج' } },
      { to: '/events', label: { en: 'Events', ar: 'الفعاليات' } },
      { to: '/online-training', label: { en: 'Online Training', ar: 'التدريب عبر الإنترنت' } },
  ...
  },
  {
    ...
    summary: {
      en: 'Use the Contact page for order, product, program or account questions that are not answered in the published help and policy pages.',
      ar: 'استخدم صفحة التواصل لأسئلة الطلبات أو المنتجات أو البرامج أو الحسابات التي لا تجيب عنها صفحات المساعدة والسياسات المنشورة.',
    },
    keywords: {
  ...
  return (
    <>
      <Seo
        ...
        description={pick({
          en: 'Support for orders, shopping, programs and accounts.',
          ar: 'دعم للطلبات والتسوق والبرامج والحسابات.',
        })}
        path="/help"
      />
      <PageHero
