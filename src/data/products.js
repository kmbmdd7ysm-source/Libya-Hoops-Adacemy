...
export const products = [
  ...
  product({
    ...
    category: 'clothing', subcategory: 't-shirts', productType: 'Performance T-Shirt', price: 38,
    colors: [{ ...C.black, image: '/images/products/hoopers-performance-tee-black.jpeg' }], stockPerVariant: 12,
  ...
  product({
    ...
    colors: [{ ...C.grey, image: '/images/products/hoopers-long-sleeve-performance-grey.jpeg' }], stockPerVariant: 10,
