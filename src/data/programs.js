...
export const programs = [
  {
    ...
    enabled: true,
    featured: true,
    name: { en: 'Youth Development', ar: 'تطوير الناشئين' },
    summary: {
    ...
    image: '/images/programs/youth-development.jpg?v=20260728-2',
  ...
  },
  {
    ...
    enabled: true,
    featured: true,
    name: { en: 'Player Development', ar: 'تطوير اللاعبين' },
    summary: {
    ...
    image: '/images/programs/player-development.jpg?v=20260728-2',
  ...
  },
  {
    ...
    enabled: true,
    featured: true,
    name: { en: 'Elite Player Development', ar: 'تطوير اللاعبين النخبة' },
    summary: {
    ...
    image: '/images/programs/elite-development.jpg?v=20260728-2',
  ...
  },
  {
    ...
    enabled: true,
    name: { en: 'Private Training', ar: 'تدريب خاص' },
    summary: {
    ...
    image: '/images/programs/private-training.jpg?v=20260728-2',
  ...
  },
  {
    ...
    enabled: true,
    name: { en: 'Small-Group Training', ar: 'تدريب مجموعات صغيرة' },
    summary: {
    ...
    image: '/images/programs/small-group.jpg?v=20260728-2',
    ages: { en: 'All ages', ar: 'جميع الأعمار' },
    level: { en: 'All levels', ar: 'جميع المستويات' },
    schedule: { en: 'Flexible booking', ar: 'حجز مرن' },
    location: { en: 'Academy court', ar: 'ملعب الأكاديمية' },
  ...
  },
  {
    ...
    slug: 'team-training',
    enabled: true,
    name: { en: 'Team Training', ar: 'تدريب الفرق' },
    summary: {
    ...
    image: '/images/programs/team-training.jpg?v=20260728-2',
  ...
  },
  {
    ...
    slug: 'shooting-lab',
    enabled: true,
    name: { en: 'Shooting Lab', ar: 'مختبر التسديد' },
    summary: {
    ...
    image: '/images/programs/shooting-lab.jpg?v=20260728-2',
  ...
  },
  {
    ...
    enabled: true,
    name: { en: 'Guard Development', ar: 'تطوير صنّاع اللعب' },
    summary: {
    ...
    image: '/images/programs/guard-development.jpg?v=20260728-2',
  ...
  },
  {
    ...
    enabled: true,
    name: { en: 'Big-Man Development', ar: 'تطوير اللاعبين الكبار' },
    summary: {
    ...
    image: '/images/programs/big-man.jpg?v=20260728-2',
    ages: { en: 'Ages 13+', ar: 'الأعمار 13+' },
    level: { en: 'Intermediate+', ar: 'متوسط فأعلى' },
    schedule: { en: 'Scheduled blocks', ar: 'فترات مجدولة' },
    location: { en: 'Academy court', ar: 'ملعب الأكاديمية' },
  ...
  },
  {
    ...
    enabled: true,
    name: { en: 'Athletic Performance', ar: 'الأداء البدني' },
    summary: {
    ...
    image: '/images/programs/athletic-performance.jpg?v=20260728-2',
    ages: { en: 'Ages 13+', ar: 'الأعمار 13+' },
    level: { en: 'All levels', ar: 'جميع المستويات' },
    schedule: { en: 'Scheduled blocks', ar: 'فترات مجدولة' },
  ...
  },
  {
    ...
    enabled: true,
    name: { en: 'Seasonal Academy Membership', ar: 'عضوية الأكاديمية الموسمية' },
    summary: {
    ...
    image: '/images/programs/membership.jpg?v=20260728-2',
    ages: { en: 'All ages', ar: 'جميع الأعمار' },
    level: { en: 'All levels', ar: 'جميع المستويات' },
  ...
  },
  {
    ...
    enabled: true,
    name: { en: 'Camps & Clinics', ar: 'المعسكرات والورش' },
    summary: {
    ...
    image: '/images/programs/camps.jpg?v=20260728-2',
    ages: { en: 'All ages', ar: 'جميع الأعمار' },
    level: { en: 'All levels', ar: 'جميع المستويات' },
